...
public class Server {
  ...
  private static final ConcurrentHashMap<String, ReentrantLock> lockStore = new ConcurrentHashMap<>();
  ...
  public static void put(String key, String value, int version)
    ...
    /**
     * theoratically, this is unnecessary. we could use store.compute to make this atomic.
     * but to mimic a distributed system, where we'd need to acquire locks manually,
     * we use a manual locking scheme here.
     */
